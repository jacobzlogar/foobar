...
# It starts as raw ore, then during processing, begins randomly changing between forms,
# eventually reaching a stable form. There may be multiple stable forms that a sample could ultimately reach,
...
# representing how many times that state has gone to the next state and 
# return an array of ints for each terminal state
...
# there is a path from that state to a terminal state. That is, the processing will 
