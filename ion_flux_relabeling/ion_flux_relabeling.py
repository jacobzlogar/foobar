...
# 
#        7 /   \ 3      6 /  \   / \ 1   2  4   5 Write a function answer(h, q)
#        - where h is the height of the perfect tree of converters and q is a
#        list of positive integers representing different flux converters -
#        which returns a list of integers p where each element in p is the
#        label of the converter that sits on top of the respective converter in
#        q, or -1 if there is no such converter. For example, answer(3, [1, 4,
#        7]) would return the converters above the converters at indexes 1, 4,
...
# Inputs:
# 
# (int) h = 3 (int list) q = [7, 3, 5, 1] Output:
# 
# (int list) [-1, 7, 6, 3] Inputs:
# 
