...
# first one. In this case, pegs would be [4, 30, 50] and answer(pegs) should
# return [12, 1].
# 
...
# Test cases ==========
# 
# Inputs: (int list) pegs = [4, 30, 50] Output: (int list) [12, 1]
# 
# Inputs: (int list) pegs = [4, 17, 50] Output: (int list) [-1, -1]
